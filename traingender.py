...
checkpoint = ModelCheckpoint(filepath='file_model.h5',monitor='val_loss',mode='auto' ,save_best_only='True')
...
model = keras.Sequential([
    keras.layers.Conv2D(32, (3, 3), input_shape=(IMAGE_W, IMAGE_H, 3), strides=(1, 1), activation='relu', padding='SAME'),
    keras.layers.MaxPool2D(pool_size=(2, 2)),
    keras.layers.Conv2D(64, (3, 3), strides=(1, 1), activation='relu', padding='SAME'),
    # keras.layers.Conv2D(16, (3, 3), strides=(1, 1), activation='relu', padding='SAME'),
    keras.layers.MaxPool2D(pool_size=(2, 2)),
...
sgd_optimizer = SGD(lr=learning_rate, decay=learning_rate/(epochs), momentum=0.9, nesterov=True)
